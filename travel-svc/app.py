...
logging.basicConfig(
    level=logging.INFO,
    format='[%(asctime)s] [%(levelname)s] [Travel] %(message)s',
    datefmt='%Y-%m-%d %H:%M:%S'
)

# Base de datos en memoria: historial de viajes y visas de personas
DATABASE = [
    {
        "id": "12345",
        "name": "Juan Perez",
    ...
    },
    {
        ...
        "destination": "Canadá",
        "visa_type": "Visitante",
        "visa_status": "Expirada",
        "last_travel_date": "2023-05-10",
        "entry_count": 1
    },
    {
        "id": "22222",
        ...
        "phone": "555-2222",
        "destination": "México",
        "visa_type": "No requerida",
        "visa_status": "N/A",
        "last_travel_date": "2024-11-01",
        "entry_count": 7
    }
]
    ...
    try:
        ...
        if person:
            result = {
                ...
                "visa_type": person.get("visa_type"),
                "visa_status": person.get("visa_status"),
                "last_travel": person.get("last_travel_date"),
                "entry_count": person.get("entry_count"),
                "service": "travel"
            }
