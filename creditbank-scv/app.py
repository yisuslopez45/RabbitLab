...
logging.basicConfig(
    level=logging.INFO,
    format='[%(asctime)s] [%(levelname)s] [OfficialRecords] %(message)s',
    datefmt='%Y-%m-%d %H:%M:%S'
)

# Base de datos en memoria: registros oficiales de personas
DATABASE = [
    {"id": "12345", "name": "Juan Perez", "phone": "555-1234", "credit": "Activo"},
    {"id": "67890", "name": "Maria Garcia", "phone": "555-5678", "credit": "Vencido"},
    {"id": "11111", "name": "Carlos Lopez", "phone": "555-9999", "credit": "Mora"},
]
